...
Like `main.py`, there's one required argument: the CSV file containing the
results.

```bash
python common/exporters/google_sheets.py output.csv
```

For more information, run

```bash
python common/exporters/google_sheets.py --help
```
